...
class Order extends Equatable {
  ...
  Map<String, dynamic> toMap() {
    var map = {
      ...
      'total': total,
      'paymentMethod':
          Config.paymentMethodToKeyString(paymentMethod: paymentMethod),
      'orderType': Config.orderTypeToKeyString(orderType),
  ...
  factory Order.fromMap(Map<String, dynamic> map) {
    ...
    return Order(
      ...
      paymentMethod: Config.paymentMethodFromKeyString(map['paymentMethod']),
      orderType: Config.orderTypeFromKeyString(map['orderType']),
